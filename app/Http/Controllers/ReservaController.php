    ...
    public function historico()
{
    ...
    public function edit($id)
    {
        ...
        if ((int) $reserva->user_id !== (int) Auth::id()) {
            abort(403, 'Unauthorized access to the reserve.');
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('reservas.minhas')->with('success', 'Reservasi berhasil diperbarui.');
    }
    ...
    public function destroy($id)
{
    ...
    return redirect()->route('reservas.minhas')->with('success', 'Reservasi dibatalkan.');
}
...
public function adminRefund($id)
{
    ...
    if ($reserva->payment_status !== 'paid') {
        return back()->with('error', 'Reservasi tidak dibayar.');
    }
...
public function downloadFatura($id)
{
    ...
    if ((int) $reserva->user_id !== (int) Auth::id()) {
        abort(403, 'Anda tidak memiliki izin untuk mengakses faktur ini.');
    }
