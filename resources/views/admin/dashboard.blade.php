            ...
            <div class="tab-pane fade show active" id="reservas" role="tabpanel" aria-labelledby="reservas-tab">
                <div class="container">
                    <div class="admin-content-card">
                        <h2 class="mb-4 text-center">Riwayat Reservasi</h2>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped align-middle">
                                ...
                                <tbody>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="10" class="text-center py-4">Tidak ada reservasi yang ditemukan.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
...
<div class="tab-pane fade" id="mensagens" role="tabpanel" aria-labelledby="mensagens-tab">
    <div class="admin-content-card">
        <h4 class="mb-3 text-center">Pesan Karyawan</h4>

        @if($messages->isEmpty())
            <p class="text-center text-muted">Tidak ada pesan yang diterima.</p>
        @else
